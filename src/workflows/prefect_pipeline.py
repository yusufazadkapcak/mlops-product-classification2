...
@flow(name="product_classification_pipeline", log_prints=True, validate_parameters=False)
def product_classification_pipeline(
    ...
    # Step 4: Split data
    data_splits = split_data_task(features, test_size=test_size, random_seed=random_seed)
