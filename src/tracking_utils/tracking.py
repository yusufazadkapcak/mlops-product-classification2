...
if 'mlflow' in sys.modules:
    ...
    if hasattr(mlflow_mod, '__file__') and mlflow_mod.__file__ and 'src' in str(mlflow_mod.__file__):
...
def setup_mlflow(
    ...
    experiment_name: str = "product_classification_experiment"
) -> None:
    """
...
def log_metric(metric_name: str, metric_value: float, step: Optional[int] = None) -> None:
